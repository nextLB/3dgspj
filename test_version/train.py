...
def main():
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[1, 10, 20, 50, 100, 150, 200, 500, 1000, 1500])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[1, 10, 20, 50, 100, 150, 200, 500, 1000, 1500])
    parser.add_argument("--quiet", action="store_true", default=False)
    parser.add_argument('--disable_viewer', action='store_true', default=False)
    parser.add_argument("--checkpoint_iterations", nargs="+", type=int, default=[1, 10, 20, 50, 100, 150, 200, 500, 1000, 1500])
    parser.add_argument("--start_checkpoint", type=str, default=10)
