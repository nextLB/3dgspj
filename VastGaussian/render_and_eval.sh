...
python render.py -s ../datasets/Mill19/rubble --exp_name rubble --eval --manhattan --platform "tj" --resolution 4 --pos "0.0 0.0 0.0" --rot "0.0 21 0.0" --load_iteration 60_000
