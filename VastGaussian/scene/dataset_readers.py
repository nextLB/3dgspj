...
def readColmapCameras(cam_extrinsics, cam_intrinsics, images_folder, man_trans, lazy_load=False):
    """
    读取COLMAP相机信息
    ...
    for idx, key in enumerate(cam_extrinsics):
        ...
        # =============================================================================
        # 【关键修改】延迟加载模式
        # lazy_load=True时，image=None，不在此处加载图像数据
...
def readColmapSceneInfo(path, images, eval, llffhold=83, lazy_load=False):
    """
    读取COLMAP场景信息
